...
решать задачи в том числе генерации и обработки сигналов.
...
С помощью скрипта из листинга \ref{Octave-sinegen} нужно сгенерировать звуковой
синусоидальный сигнал. Частота сигнала вычисляется по нижеприведённым формулам
